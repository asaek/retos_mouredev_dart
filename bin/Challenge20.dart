...
void main() async {
  print(
    await solucion(numero1: 2, numero2: 3, tiempo: 1000),
  );
}

Future<int> solucion(
        {required int numero1, required int numero2, int? tiempo}) async =>
    await Future.delayed(
        Duration(milliseconds: tiempo ?? 0), () => numero1 + numero2);
